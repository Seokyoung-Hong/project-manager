...
NEEDS: dict[str, str] = {
    ...
    "list_tasks": "read",
    "get_task": "read",
    "list_task_decisions": "read",
    "record_task_decision": "write",
    "get_pr_context": "read",
    "list_portfolio_sources": "read",
    "create_portfolio_draft": "write",
    "get_portfolio_draft": "read",
    "update_portfolio_draft": "write",
